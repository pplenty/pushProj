					...
					<table id="table_1" class="table classic">
						<thead>
							<tr>
								...
								<th style="text-align: center;">발송 시간</th>
								<th style="text-align: center;">발송</th>
								<th style="text-align: center;">오픈</th>
								<th style="text-align: center;">클릭</th>
						...
						<tbody>
							...
							<c:forEach items="${list}" var="pushCampaignDetail">
								<tr>
									...
									<td style="text-align: center;">${pushCampaignDetail.read}</td>
									<td style="text-align: center;">${pushCampaignDetail.read}</td>
									<td style="text-align: center;">${pushCampaignDetail.read}</td>
								</tr>
							</c:forEach>
