...
public class MSG_DATA_Vo implements Serializable {
	...
	// `MSG_ETC1` VARCHAR(50) NULL DEFAULT NULL COMMENT '\'MASS_I05\'',
	// `MSG_ETC2` VARCHAR(50) NULL DEFAULT NULL COMMENT 'POST_ID',
	// `MSG_ETC3` VARCHAR(50) NULL DEFAULT NULL COMMENT 'MEMBER_ID',
	// `MSG_ETC4` VARCHAR(50) NULL DEFAULT NULL COMMENT 'USER_ID',
	// `MSG_ETC5` VARCHAR(50) NULL DEFAULT NULL COMMENT '\'N\''
