...
public class MSG_LOG_Vo implements Serializable {
	...
	public int getRslt_net() {
		return rslt_net;
	}

	public void setRslt_net(int rslt_net) {
	...
	public String toString() {
		return "MSG_LOG_Vo [user_data=" + user_data + ", msg_seq=" + msg_seq
				+ ", cur_state=" + cur_state + ", sent_date=" + sent_date
				+ ", rslt_date=" + rslt_date + ", report_date=" + report_date
				+ ", req_date=" + req_date + ", rslt_code=" + rslt_code
				+ ", rslt_code2=" + rslt_code2 + ", rslt_net=" + rslt_net
				+ ", call_to=" + call_to + ", call_from=" + call_from
				+ ", sms_txt=" + sms_txt + ", msg_type=" + msg_type
				+ ", cont_seq=" + cont_seq + ", msg_etc1=" + msg_etc1
				+ ", msg_etc2=" + msg_etc2 + ", msg_etc3=" + msg_etc3
				+ ", msg_etc4=" + msg_etc4 + ", msg_etc5=" + msg_etc5 + "]";
	}
